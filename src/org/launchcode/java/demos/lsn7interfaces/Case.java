...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Strawberry", 0.5, new ArrayList<>(Arrays.asList("none")));
        Topping topping2 = new Topping("Chocolate", 0.5, new ArrayList<>(Arrays.asList("none")));
        Topping topping3 = new Topping("Caramel", 0.5, new ArrayList<>(Arrays.asList("none")));
